...
- Think about all corner Casess
- $or query in mongoose - https://www.mongodb.com/docs/manual/reference/mql/query-predicates/logical/
- schema.pre("save") function
- read more avout index in mongo db
